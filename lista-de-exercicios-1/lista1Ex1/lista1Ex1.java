...
/* Esse exercício não foi 100% implementado porque ele tomou uma proporção muito maior
  do que eu esperava, então implentar todas as funções necessárias no modelo que eu 
  decidi seguir tomaria mais tempo e o toarnaria ainda mais complexo, sendo que ele já 
  é excessivamente complexo.
*/

import java.util.Scanner;
import lista1ex1.cliente.*;
